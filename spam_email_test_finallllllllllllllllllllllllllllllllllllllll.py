# -*- coding: utf-8 -*-
"""Spam_email_test_finallllllllllllllllllllllllllllllllllllllll.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1xwmk087vI2Ogk6vRqVlvmEjzPXIbXSYf
"""
...
df= pd.read_csv(
    "/content/drive/MyDrive/sorkon.csv")
df
...
df2['return_path']=df2['return_path'].str.lower()
df2['slash_all_return']=df2['return_path'].str.extract('(?P<slash_all_return>[^@]+$)')
df2['slash_all_return']=df2['slash_all_return'].str.strip()
comparison_column1 = np.where(df2["slash_all"] == df2["slash_all_return"], True, False)
df2["equal_1"] = comparison_column1
lee = LabelEncoder()
df2['Equal_1']= lee.fit_transform(df2['equal_1']) #หลักการของมันคือ เรียงตามตัวอักษรในที่นี้คือ bad=0, good=1 
df2.drop(['equal_1'],axis=1,inplace=True)
...
dt27 =dt26[['sender_address','recp_address','return_path','message_subject','Suspect_sender','Prob_bad','Prob_good','Suspect_message_subject','Prob_0','Prob_1','event_name','directionality','recp_count','blacklist_word','blacklist_word1','Equal_1']]
dt27
